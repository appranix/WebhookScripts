...
def HttpTrigger(req: func.HttpRequest) -> func.HttpResponse:
    try:
        ...
        for id in list(resources):
            if id.type == "Microsoft.DBforPostgreSQL/flexibleServers" and id.location == location:
                server_name = id.name
                ...
                url = f"https://management.azure.com/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.DBforPostgreSQL/flexibleServers/{server_name}/backups?api-version=2022-12-01"
                ...
                if not snapshots:
                    ...
                    url = f"https://management.azure.com/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.DBforPostgreSQL/flexibleServers/{recovery_server_name}?api-version=2023-03-01-preview"
                    payload = {
                                    "location": location,
                                    "properties": {
                                        "createMode": "PointInTimeRestore",
                                        "sourceServerResourceId": f"/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.DBforPostgreSQL/flexibleServers/{server_name}",
                                        "pointInTimeUTC":restore_point_time
                                    }
                                }
