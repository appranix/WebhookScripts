...
def retrieve_json_from_azure_storage(container_name, file_name, connection_string):
    try:
        ...
        server_name = python_objects.get("server_name")
        replica_name = python_objects.get("replica_name")
        location = python_objects.get("location")
        recovery_region = python_objects.get("recovery_region")
        resource_group_name = python_objects.get("source_resource_group_name")

        return server_name, replica_name , location , recovery_region , resource_group_name
...
def HttpTrigger(req: func.HttpRequest) -> func.HttpResponse:
    try:
        ...
        server_name, replica_server_name , location , recovery_region,resource_group_name= retrieve_json_from_azure_storage(container_name, file_name, connection_string)
        replica_name=""
