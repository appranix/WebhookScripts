...
def HttpTrigger(req: func.HttpRequest) -> func.HttpResponse:
    try:
        ...
        # Loop through the resources to find PostgreSQL replicas in the specified location
        for resource in resources:
            if resource.type.lower() == "Microsoft.DBforPostgreSQL/flexibleServers".lower() and resource.location == location:
                ...
                if replica_name == "":
                    ...
                    if response.status_code in [200, 201, 202]:
                        ...
                        url = f"https://management.azure.com/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.DBForPostgreSql/flexibleServers/{rec_replica_name}?api-version=2022-03-08-preview"
                        payload = {
                            "location": f"{location}",
                            "properties": {
                                "createMode": "Replica",
                                "SourceServerResourceId": f"/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.DBForPostgreSql/flexibleServers/{replica_name}"
                            }
                        }
